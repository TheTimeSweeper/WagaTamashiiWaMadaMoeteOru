...
namespace SillyKnockbackFin
{
    internal static partial class Config
    {
        ...
        public static class ImgHandler
        {
            ...
            {
                Texture2D texture2D = LoadPNG(fullFilePath, pointFilter);
                if (pointFilter)
                {
            ...
            {
                string fullFilePath = Path.Combine(Path.GetDirectoryName(SillyKnockbackFinPlugin.instance.Info.Location), fileName);
